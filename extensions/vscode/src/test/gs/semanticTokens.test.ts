...
import {parseGsSemanticTokensData} from '../../features/gs/semanticTokens';

suite('GS Semantic Tokens Test Suite', () => {
    test('parseGsSemanticTokensData parses correctly', () => {
        const builder = {
            tokens: [] as any[],
        ...
        parseGsSemanticTokensData([0, 0, 5, 0, 0, 1, 5, 3, 1, 0], builder);
